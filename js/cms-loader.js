...
class CMSDataLoader {
    ...
    updatePageContent() {
        ...
        console.log('Homepage DEBUG: Content data length:', data.content ? Object.keys(data.content).length : 'null');
        console.log('Homepage DEBUG: Subtitle length:', data.content && data.content.homepage_subtitle ? data.content.homepage_subtitle.length : 'not found');
        console.log('Homepage DEBUG: Full subtitle:', JSON.stringify(data.content && data.content.homepage_subtitle));
        ...
        if (data.content && data.content.homepage_subtitle) {
            ...
            if (subtitleElement) {
                const fullSubtitle = String(data.content.homepage_subtitle);
                console.log('Homepage DEBUG: Updating subtitle to:', fullSubtitle);
                console.log('Homepage DEBUG: Subtitle length:', fullSubtitle.length);
                subtitleElement.textContent = fullSubtitle;
            } else {
